...
# Bot information
API_ID = environ.get('API_ID', '28269435')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '839f282133fe8ee79b4a946095cf4360') #api hash of your telegram id
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7718138956:AAGH2dm6S6e0oJyn_6XAHC45HvNP7vhgILQ') #bot token from botfather
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '1511468725') #apni tg id daalo
if len(ADMINS) == 0:
...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002282093291').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001965914571') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001599336908') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Hanuman:hanuman@cluster0.l5toshc.mongodb.net/?retryWrites=true&w=majority") #mongo db url
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/+hf0frQmRGu41Yzll')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001965914571") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://app.koyeb.com/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
